    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_signUp.setOnClickListener {
            if (hasErr == null || hasErr == true) {
                ...
                signup.request(parm).enqueue(object : Callback<SignupOut> {
        ...
        val SIGNUP_FIELD_CHANGE_LISTENER = object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                if (te_name.text.toString() == "") {
                    hasErr = true
                    tv_nameErr.setText(R.string.signup_required_input)
                    return
                } else {
                    tv_nameErr.text = ""
                    hasErr = false
                ...
                if (!checkNickName(te_nick.text.toString())) {
                    hasErr = true
                    tv_nicknameErr.setText(R.string.signup_nickname_length)
                    return
                } else {
                    tv_nicknameErr.text = ""
                    hasErr = false
                ...
                if (!isEmail(te_emailID.text.toString())) {
                    hasErr = true
                    tv_emailErr.setText(R.string.signup_not_email)
                    return
                } else {
                    tv_emailErr.text = ""
                    hasErr = false
                ...
                if (te_password.text.toString() != te_pwConfirm.text.toString()) {
                    hasErr = true
                    tv_confirmErr.setText(R.string.signup_not_match_password)
                    return
                } else {
                    tv_confirmErr.text = ""
                    hasErr = false
                ...
                if (!checkPWformet(
                    ...
                    hasErr = true
                    tv_pwErr.setText(R.string.signup_password_format)
                    return
                } else {
                    tv_pwErr.text = ""
                    hasErr = false
                ...
                if (!checkPhoneNumber(
                    ...
                    hasErr = true
                    tv_emergencyError.setText(R.string.signup_not_corrent_format)
                    return
                } else {
